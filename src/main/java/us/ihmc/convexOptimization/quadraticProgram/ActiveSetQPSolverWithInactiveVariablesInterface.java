 ...
 * ignore during the next {@link #solve(DenseMatrix64F)}, cutting computation time to a similar
...
public interface ActiveSetQPSolverWithInactiveVariablesInterface extends ActiveSetQPSolver
{
    ...
    * variables for the next {@link #solve(DenseMatrix64F)}.
    * 
    ...
    * component is expected after the next call to {@link #solve(DenseMatrix64F)}.
    * 
    ...
    * ignored for the next call of {@link #solve(DenseMatrix64F)}.
    * 
    ...
    * solved for during the next call of {@link #solve(DenseMatrix64F)}.
    */
